...
import { uploadVideo, saveVideo } from './redux-state/uploadAction';
...
class PostVideo extends Component {
    ...
    handleSubmit = event => {
        ...
        this.props.saveVideo(videoData);
                                        ...
                                        <div className="large-12 columns">
                                            ...
                                            <form style={{position: 'relative'}} onSubmit={this.handleSubmit} >
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="large-12 columns">
                                                        <button type="submit" className="button expanded upldbtn">publish now</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
...
export default connect(mapStateToProps, { uploadVideo, saveVideo })(PostVideo);